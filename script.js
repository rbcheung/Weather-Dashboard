    ...
    searchBtn.on("click", function(event) {
        ...
        $.ajax({
          ...
          .then(function(response) {
            ...
            currentWeather.append($("<img>").attr("src", "https://openweathermap.org/img/wn/" + response.weather[0].icon + "@2x.png"))
            todaySection.append($("<p>").text("Temp:" + " " + response.main.temp + "°C"))
            todaySection.append($("<p>").text("Wind:" + " " + response.wind.speed + " " + "mps"))
            todaySection.append($("<p>").text("Humidity:" + " " + response.main.humidity+ "%"))
            ...
            $.ajax({
                ...
                .then(function(response) {
                  ...
                  for (var i =0; i< response.list.length; i+= 8) {
                    ...
                    var futureDate = moment.unix(response.list[i].dt).format("MM/DD/YYYY");
